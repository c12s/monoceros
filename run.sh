...
if [ "$#" -ne 10 ]; then
  echo "Usage: $0 NODE_ID NODE_REGION HTTP_SERVER_ADDR RN_LISTEN_ADDR GN_LISTEN_ADDR RRN_LISTEN_ADDR RN_CONTACT_NODE_ID RN_CONTACT_NODE_ADDR GN_CONTACT_NODE_ID GN_CONTACT_NODE_ADDR"
  exit 1
fi
...
RN_CONTACT_NODE_ID=$7
RN_CONTACT_NODE_ADDR=$8

GN_CONTACT_NODE_ID=$9
GN_CONTACT_NODE_ADDR=${10}

echo $GN_CONTACT_NODE_ADDR
...
export HTTP_SERVER_ADDR="$HTTP_SERVER_ADDR"
